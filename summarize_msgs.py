# summarize_msgs.py
# 2026-08-19  Jonghyun Park w/ Claude
"""
...
# .msg 파일이 있는 폴더
SOURCE_DIR = Path(
    r"C:\Users\user_name\Downloads\mail_search_260511"
)
...
def main() -> int:
    ...
    out_path = out_dir / f"{OUTPUT_BASUB_CME}_{timestamp}.md"

    existing = sorted(out_dir.glob(f"{OUTPUT_BASUB_CME}_*.md"))
